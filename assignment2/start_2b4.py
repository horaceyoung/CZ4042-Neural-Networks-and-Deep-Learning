...
for epoch in range(no_epochs):
    ...
    for images, labels in train_ds:
        train_step(model, images, labels, drop_rate=0)  # drop_rate=0 unless not DO_B5
...
plt.xlabel('epoch')
plt.legend()
plt.savefig(f'./results_b/B4_Losses.png')
plt.close()
...
plt.xlabel('epoch')
plt.legend()
plt.savefig(f'./results_b/B4_Accuracies.png')
plt.close()
...
plt.ylabel('Cost')
plt.xlabel('epoch')
plt.savefig(f'./results_b/B4_train_cost.png')
plt.close()
...
plt.ylabel('Accuracy')
plt.xlabel('epoch')
plt.savefig(f'./results_b/B4_test_acc.png')
plt.close()
